/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 94edb6ad4b610811d2c019339e4f5d14)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_BLOBS: R2Bucket;
	RESTRICTED_BLOBS: R2Bucket;
	EXPORTS: R2Bucket;
	EVENTS?: Queue;
	EDGEFOSS_ENV: "staging" | "production" | "dev";
	EDGEFOSS_OWNER_TOKEN?: string;
	REPOSITORY: DurableObjectNamespace<import("./index").RepositoryDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RepositoryDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EDGEFOSS_ENV" | "EDGEFOSS_OWNER_TOKEN">> {}
}
